...
print("angka-1 > angka-2 =", hasil1_1011)

#lebih kecil dari
hasil2_1011 = angka1_1011 < angka2_1011
print("\nOperator lebih kecil dari")
print("angka-1 < angka-2 =", hasil2_1011)

#lebih besar dari atau sama dengan
hasil3_1011 = angka1_1011 >= angka2_1011
print("\nOperator lebih besar dari atau sama dengan")
print("angka-1 >= angka-2 =", hasil3_1011)

#lebih kecil dari atau sama dengan
hasil4_1011 = angka1_1011 <= angka2_1011
print("\nOperator lebih kecil dari atau sama dengan")
print("angka-1 <= angka-2 =", hasil4_1011)

#sama dengan
hasil5_1011 = angka1_1011 == angka2_1011
print("\nOperator sama dengan")
print("angka-1 == angka-2 =", hasil5_1011)

#tidak sama dengan
hasil6_1011 = angka1_1011 != angka2_1011
print("\nOperator tidak sama dengan")
print("angka-1 != angka-2 =", hasil6_1011)

#perbandingan berantai 
hasil7_1011 = 0 < angka1_1011 < 100
print("\nOperator perbandingan berantai")
print("0 < angka-1 < 100 =", hasil7_1011)

hasil8_1011 = 0 < angka2_1011 < 100
print("0 < angka-2 < 100 =", hasil8_1011)
